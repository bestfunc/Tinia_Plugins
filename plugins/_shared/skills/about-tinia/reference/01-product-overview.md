...
- **Pro / Server** 跟传统 NVH 软件相比，单 seat 价格更低，是因为云原生 + 订阅 + AI 增效让单 seat 边际成本接近零（传统软件基于桌面单机架构，边际成本结构不同）
- **Server** 让公司客户能像传统大厂一样团队部署，但获得 AI + 节点商店的新工作方式
- **Community** 是传统大厂不敢做的 —— 他们的核心客户是大企业，免费版会侵蚀付费版。Tinia 起步阶段没有存量包袱
- **Production** 是 SmartQuality（Bestfunc 现有产品线）客户的自然升级，2027 启动
...
2. **5 个 SKU 产品矩阵**（Community / Pro / Server / SaaS / Production）覆盖学生到工厂全谱，按场景对应推荐
3. **MCP-native** 是架构层面的领先，不是后期能加的功能 —— 这一点 5 年内对手追不上
4. **节点商店** 是 2027 主线之一，今年内部跑通明年开放，但今天就可以跟客户讲
5. **不要被算法清单（134 项笛卡尔积）压住** —— HEAD 经过 30 年累积达到 134 项，Tinia 用 2 年到 60+ 项 + AI 编排，**价值在工作方式而非算法数量**
